...
<style>
    ...
    .nu-button.nu-button--fab,
    .nu-button.nu-button--icon,
    .nu-button.nu-button--toggle {
    transition: none;
    }
    ...
    .nu-button--fab.nu-button--small {
    --fab-size: 40px;
    }

    .nu-button--fab.nu-button--medium {
    --fab-size: 48px;
    }

    .nu-button--fab.nu-button--large {
    --fab-size: 56px;
    }

    .nu-button.nu-button--small {
    --btn-height: 30px;
    }

    .nu-button.nu-button--medium {
    --btn-height: 36px;
    }

    .nu-button.nu-button--large {
    --btn-height: 42px;
    }

    .nu-button.nu-button--block {
    display: flex;
    }

    .nu-button.nu-button--rounded {
    border-radius: 56px !important;
    }

    .nu-button.nu-button--disabled {
    opacity: 0.6;
    pointer-events: none;
    ...
    .nu-button.nu-button--text {
    box-shadow: none !important;
    transition: none !important;
    --bg-color: transparent !important;
    }

    .nu-button.nu-button--bordered {
    border: 1px solid var(--light-border-color);
    }

    .nu-button.nu-button--outlined {
    box-shadow: none !important;
    transition: none !important;
    --bg-color: transparent !important;
    ...
    .nu-button:active,
    .nu-button.nu-button--active {
    transition: none !important;
    }

    .nu-button:active,
    .nu-button.nu-button--active:active {
    ...
    .nu-button.nu-button--no-press:active {
    box-shadow: none !important;
    }
    ...
    .nu-button.nu-button--outlined:focus {
    padding: 0 11px;
    }
